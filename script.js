...
function setupScrollAnimations() {
  ...
  const animatedElements = document.querySelectorAll(".fade-in-up, .fade-in-left, .fade-in-right, .animate-on-scroll")
...
function validateForm(form) {
  ...
  requiredFields.forEach((field) => {
    ...
    if (!value) {
      ...
      showFieldError(fieldGroup, errorMessage, "Please enter a valid email address")
      isValid = false
    } else if (field.type === "tel" && !isValidPhone(value)) {
      showFieldError(fieldGroup, errorMessage, "Please enter a valid phone number")
      isValid = false
...
function populatePackageModal(packageName, packagePrice) {
  ...
  document.getElementById("package-modal-title").textContent = `${packageName} - Application`
}
...
function getServiceInfo(serviceName) {
  ...
  return (
    services[serviceName] || {
      ...
      features: ["Professional Service", "Expert Support", "Competitive Pricing"],
